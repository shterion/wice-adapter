...
async function checkForExistingPerson(person, cookie, options) {
  ...
  try {
    options.form = {
      ...
      cookie,
      ext_search_do: 1,
      // name: person.body.name, // TODO: person.body.data.name
      name: person.body.data.name, // TODO: person.body.data.name
    };
...
async function createOrUpdatePerson(existingRowid, cookie, options, msg) {
  try {
    if (existingRowid === 0) {
      ...
      // const input = JSON.stringify(msg.body); // TODO: msg.body.data
      const input = JSON.stringify(msg.body.data); // TODO: msg.body.data
      options.form = {
    ...
    // msg.body.rowid = existingRowid; // TODO: msg.body.data.rowid
    msg.body.data.rowid = existingRowid; // TODO: msg.body.data.rowid
    options.form = {
      method: 'update_contact',
      // data: JSON.stringify(msg.body), // TODO: msg.body.data
      data: JSON.stringify(msg.body.data), // TODO: msg.body.data
      cookie,
    };
