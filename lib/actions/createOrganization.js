...
function processAction(msg, cfg) {
  ...
  // Create a session in wice and then make a post request to create a new organization in snazzycontacts
  wice.createSession(cfg, () => {
    if (cfg.cookie) {
      ...
      // Send a request to create a new organization in wice
      request.post(uri)
        .then((res) => {
          reply = res;
          emitData();
