...
function processTrigger(msg, cfg, snapshot = {}) {
  ...
  async function getPersons() {
    try {
      ...
      const options = {
        uri: `https://oihwice.wice-net.de/plugin/wp_wice_client_api_backend/json?method=get_all_persons&full_list=1&cookie=${cookie}`,
        headers: { 'X-API-KEY': undefined } // cfg.apikey
      };
